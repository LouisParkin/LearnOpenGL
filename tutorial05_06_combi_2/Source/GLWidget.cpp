...
void GLWidget::glutRender()
{
  ...
  /// world represents an identity matrix [4x4] with it's last columns rows representing
  /// x, y and z coordinates of our triangle.  We use a cosine function on the x coordinate,
  /// and a sine function on the y coordinate to get a desired circular result.

  world.m[0][0] = 1.0f; world.m[0][1] = 0.0f; world.m[0][2] = 0.0f; world.m[0][3] = cosf(scale);  ///< [ 1 0 0 X ]   [ cos(scale) ]   [ X + cos(scale) ]
  world.m[1][0] = 0.0f; world.m[1][1] = 1.0f; world.m[1][2] = 0.0f; world.m[1][3] = sinf(scale);  ///< [ 0 1 0 Y ] * [ sin(scale) ] = [ Y + sin(scale) ]
  world.m[2][0] = 0.0f; world.m[2][1] = 0.0f; world.m[2][2] = 1.0f; world.m[2][3] = 0.0f;         ///< [ 0 0 1 Z ]   [ 0 ]            [ Z + 0          ]
  world.m[3][0] = 0.0f; world.m[3][1] = 0.0f; world.m[3][2] = 0.0f; world.m[3][3] = 1.0f;         ///< [ 0 0 0 1 ]   [ 0 ]            [ 1 + 0          ]
